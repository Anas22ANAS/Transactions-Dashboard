...
//               <Form.Label>اختر عميلًا لعرض الرسم البياني</Form.Label>
...
//               <Form.Label>تصفية حسب اسم العميل أو مبلغ المعاملة</Form.Label>
//               <Form.Control type="text" placeholder="البحث..." onChange={handleFilterChange} value={filterText} />
//             </Form.Group>
//           </Form>
//         </Col>
//       </Row>
...
//       <Row className="my-4">
//         <Col>
//           <h2>رسم بياني للعمليات</h2>
//           <ResponsiveContainer width="100%" height={400}>
//             <LineChart
//               data={selectedCustomer ? getTransactionData() : transactions.map(transaction => ({
//                 date: transaction.date,
//                 amount: transaction.amount
//               }))}
